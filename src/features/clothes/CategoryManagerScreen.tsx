...
export default function CategoryManagerScreen() {
    ...
    const { categories, addCategory, updateCategory, deleteCategory } = useClothesStore();
    ...
    const handleDelete = (id: string, name: string) => {
        Alert.alert(
            "Delete Category",
            `Are you sure you want to delete '${name}'? Clothes in this category will be moved to 'Uncategorized'.`,
            [
